...
import com.ishan.Train.Entity.TrainSchedule;
import com.ishan.Train.repo.StationRepository;
import com.ishan.Train.repo.TrainRepository;
import com.ishan.Train.repo.TrainScheduleRepository;
...
public class Test {
    ...
    public void test()
    {
        ...
        Train rajdhani = new Train(null,"Raj Dhani", "12306", null);
